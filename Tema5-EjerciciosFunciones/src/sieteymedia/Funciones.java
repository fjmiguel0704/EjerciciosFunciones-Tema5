...
public class Funciones {
	...
	public static void turnoJugador1(double[] tabla) {
		...
		while (respuestaJ1.equals("s")) {
			...
			if (tabla[numero]==8) {
				System.out.println("Tu carta es: " + tabla[numero] + " sota de " + paloEscrito);
			}
			if (tabla[numero]==9) {
				System.out.println("Tu carta es: " + tabla[numero] + " caballo de " + paloEscrito);
			}
			
			if (tabla[numero]==10) {
				System.out.println("Tu carta es: " + tabla[numero] + " rey de " + paloEscrito);
			}
